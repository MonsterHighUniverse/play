...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_measurementIdOverride": "G-6S5N2RJHSR",
            ...
            "predicates": [{
                ...
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "purchase_api-2023-pro-plan-mothly"
            }, {
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "purchase_api-2023-pro-plan-yearly"
            }, {
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "purchase_api-creator-plan-monthly"
            }, {
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "purchase_api-creator-plan-yearly"
            }, {
                "function": "_re",
                "arg0": ["macro", 0],
                "arg1": "^purchase_.*"
    ...
    */
    ...
    ni.oe = Number("0") || 0;
    ni.ia = "dataLayer";
    ni.fk = "ChEIgIHnqgYQ6K7U08Trh56vARIlAIdSM1rvc64+zC/84nT5xxhNDNOix5bJ2Q+Clj8MrvevGbSL5hoC3uY\x3d";
    var qi = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var lj;
    try {
        lj = JSON.parse(yb("eyIwIjoiUFQiLCIxIjoiUFQtMTEiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5wdCIsIjQiOiJyZWdpb24xIiwiNSI6ZmFsc2UsIjYiOnRydWUsIjciOiJhZF9zdG9yYWdlfGFuYWx5dGljc19zdG9yYWdlfGFkX3VzZXJfZGF0YXxhZF9wZXJzb25hbGl6YXRpb24ifQ"))
    } catch (a) {
        O(123), kj(2), lj = {}
    }
    var mj = function() {
        ...
        function() {
            ...
            function b(f, g, k) {
                ...
                if (nb(q)) {
                    var r = !1,
                        t;
                    for (t in q) q.hasOwnProperty(t) && (r || (c.push(5), r = !0), "currencyCode" === t ? n("currency", q.currencyCode) : "impressions" === t && g === Q.g.cb ? p(q.impressions, null) : "promoClick" === t && g === Q.g.qb ? p(q.promoClick.promotions, q.promoClick.actionField, !0) : "promoView" === t && g === Q.g.eb ? p(q.promoView.promotions,
            ...
            (function(f) {
                ...
                if (h(g) && 0 === g.indexOf("G-")) {
                    ...
                    var t = xH(f.vtp_eventParameters,
                            "name", "value"),
                        u;
