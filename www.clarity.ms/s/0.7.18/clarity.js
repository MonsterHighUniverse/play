/* clarity-js v0.7.18: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get queue() {
    ...
    function A(t, e) {
        gi() && t && "string" == typeof t && t.length < 255 && (j = e && "string" == typeof e && e.length < 255 ? {
            key: t,
            value: e
        } : {
            value: t
    ...
    function W(t, e, n) {
        return window.setTimeout(ei(t), e, n)
    }
    ...
    function F() {
        ...
        L = {
            gap: t - P
        }, gr(25), L.gap < 3e5 ? B = W(F, U) : hi && (A("clarity", "suspend"), Di(), ["mousemove", "touchstart"].forEach((function(t) {
            return ai(document, t, bi)
        })), ["resize", "scroll", "pageshow"].forEach((function(t) {
            return ai(window, t, bi)
        })))
    }
    var J = Object.freeze({
            __proto__: null,
    ...
    function et(t) {
        gi() && o.lean && (o.lean = !1, tt = {
            key: t
        }, Yr(), o.upgrade && o.upgrade(t), gr(3))
    }
    ...
    function ct(t, e) {
        if (gi() && t && e && "string" == typeof t && t.length < 255) {
    ...
    function Et(t, e, n) {
        o.fraud && null !== t && n && n.length >= 5 && (wt = {
            ...
            target: e,
            checksum: d(n, 24)
        }, kt.indexOf(wt.checksum) < 0 && (kt.push(wt.checksum), Ka(41)))
    }
    ...
    var oe = Object.freeze({
            ...
            add: function(t, e, n, a) {
                var r, i = Vt(t, !0),
                    ...
                    f = o.content ? 1 : 3;
                u >= 0 && _t[u] && ((s = _t[u]).children.push(i), l = null === l ? s.region : l, d = null === d ? s.metadata.fraud : d, f = s.metadata.privacy), n.attributes && "data-clarity-region" in n.attributes && (Fe(t, n.attributes["data-clarity-region"]), l = i), Mt.set(i, t), _t[i] = {
                        id: i,
                        parent: u,
                        previous: c,
                        children: [],
                ...
                if (r in _t) {
                    ...
                    if (s.metadata.active = !0, s.previous !== o && (u = !0, s.previous = o), s.parent !== i) {
                        ...
                        if (s.parent = i, null !== i && i >= 0) {
                            ...
                            _t[i].children.splice(d, 0, r), s.region = Je(t) ? r : _t[i].region
                        } else ! function(t, e) {
                            if (t in _t) {
                                var n = _t[t];
    ...
    function ve() {
        ...
        t && (le = t, t.task().then((function() {
            t.id === Rr() && (t.resolve(), le = null, ve())
        })).catch((function(e) {
            t.id === Rr() && (e && Qa(0, 1, e.name, e.message, e.stack), le = null, ve())
        })))
    }
    ...
    var Ne = [],
        ...
        _e = null,
        Ie = null,
        Ce = "clarityAnimationId",
        De = "clarityOperationCount",
        je = 20;
        ...
        null === t && (t = Animation.prototype[e], Animation.prototype[e] = function() {
            if (gi()) {
                ...
                if (null !== a && n.getKeyframes && n.getTiming) {
                    if (!this[Ce]) {
                        this[Ce] = Xr(), this[De] = 0;
                        var r = n.getKeyframes(),
                            i = n.getTiming();
                        Le(s(), this[Ce], 0, JSON.stringify(r), JSON.stringify(i), a)
                    }
                    if (this[De]++ < je) {
                        var o = null;
                        switch (e) {
    ...
    function ze(t, e, n) {
        return void 0 === e && (e = null), void 0 === n && (n = null), at(this, void 0, void 0, (function() {
            var a, r, i, u, c, l, d, f, h, p, v, g, b, y, w, k, E, O, S, x, N, T, I, C, D;
            return rt(this, (function(j) {
                switch (j.label) {
                    case 0:
                        ...
                        return [3, 11];
                    case 1:
                        return i = Ee, r.push(i.width), r.push(i.height), M(t, i.width, i.height), qa(r), [3, 11];
                    case 2:
                        for (u = 0, c = We; u < c.length; u++) l = c[u], (r = [l.time, 7]).push(l.data.id), r.push(l.data.interaction), r.push(l.data.visibility), r.push(l.data.name), qa(r);
                        return $e(), [3, 11];
                    case 3:
                        for (d = 0, f = Ne; d < f.length; d++) h = f[d], (r = [h.time, h.event]).push(h.data.id), r.push(h.data.operation), r.push(h.data.keyFrames), r.push(h.data.timing), r.push(h.data.timeline), r.push(h.data.targetId), qa(r);
                        return Ae(), [3, 11];
                    case 4:
                        if (2 === ge(e)) return [3, 11];
                        if (!((p = ne()).length > 0)) return [3, 10];
                        v = 0, g = p, j.label = 5;
                    case 5:
                        return v < g.length ? (b = g[v], 0 !== (y = ge(e)) ? [3, 7] : [4, ye(e)]) : [3, 9];
                    case 6:
                        y = j.sent(), j.label = 7;
                    case 7:
                        if (2 === y) return [3, 9];
                        for (w = b.data, k = b.metadata.active, E = b.metadata.suspend, O = b.metadata.privacy, S = function(t) {
                                var e = t.metadata.privacy;
                                return "*T" === t.data.tag && !(0 === e || 1 === e)
                            }(b), x = 0, N = k ? ["tag", "attributes", "value"] : ["tag"]; x < N.length; x++)
                            if (w[T = N[x]]) switch (T) {
                                case "tag":
                                    I = He(b), C = S ? -1 : 1, r.push(b.id * C), b.parent && k && r.push(b.parent), b.previous && k && r.push(b.previous), r.push(E ? "*M" : w[T]), I && 2 === I.length && r.push("".concat("#").concat(Ye(I[0]), ".").concat(Ye(I[1])));
                                    break;
                                case "attributes":
                                    for (D in w[T]) void 0 !== w[T][D] && r.push(qe(D, w[T][D], O));
                                    break;
                                case "value":
                                    Et(b.metadata.fraud, b.id, w[T]), r.push(m(w[T], w.tag, O, S))
                            }
                        j.label = 8;
                    case 8:
                        return v++, [3, 5];
                    case 9:
                        6 === t && _(a), qa(function(t) {
    ...
    function Fe(t, e) {
        !1 === Xe.has(t) && (Xe.set(t, e), (Ve = null === Ve && Be ? new IntersectionObserver(Ge, {
            threshold: [0, .2, .4, .6, .8, 1]
        }) : Ve) && t && t.nodeType === Node.ELEMENT_NODE && Ve.observe(t))
    }
    ...
    function Ke() {
        for (var t = [], e = 0, n = Ue; e < n.length; e++) {
            var a = n[e],
                r = Vt(a.node);
            r in Pe || (r ? (a.data.id = r, Pe[r] = a.data, We.push(Qe(a.data))) : t.push(a))
        }
        Ue = t, We.length > 0 && ze(7)
    }
    ...
    function Ge(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            var a = n[e],
                ...
                u = a.rootBounds;
            if (Xe.has(r) && i.width + i.height > 0 && u.width > 0 && u.height > 0) {
                var c = r ? Vt(r) : null,
                    s = c in Pe ? Pe[c] : {
                        id: c,
                        name: Xe.get(r),
                ...
                Ze(r, s, s.interaction, d ? 13 : l ? 10 : 0), s.visibility >= 13 && Ve && Ve.unobserve(r)
            }
        }
        We.length > 0 && ze(7)
    }
    ...
    function Ze(t, e, n, a) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = a > e.visibility ? a : e.visibility, e.id ? (e.id in Pe && r || !(e.id in Pe)) && (Pe[e.id] = e, We.push(Qe(e))) : Ue.push({
            node: t,
            data: e
        })
    }
    ...
    var rn = ["input", "textarea", "radio", "button", "canvas"],
        on = [];

    function un(t) {
        ai(t, "click", cn.bind(this, 9, t), !0)
    }
    ...
    function bn(t) {
        ...
        if (e && e.type && n) {
            ...
            mn.length > 0 && mn[mn.length - 1].data.target === r.target && mn.pop(), mn.push({
                time: s(t),
                event: 27,
                data: r
            }), X(gn), gn = W(yn, 1e3, 27)
    ...
    function xn(t, e, n) {
        ...
        if (i)
            for (var u = 0; u < i.length; u++) {
                ...
                l = l && a ? l + Math.round(a.offsetLeft) : l, d = d && a ? d + Math.round(a.offsetTop) : d, null !== l && null !== d && Nn({
                    time: o,
                    event: t,
                    data: {
                        target: Oa(n),
    ...
    function Nn(t) {
        switch (t.event) {
            ...
            case 19:
                ...
                }(n, t) && En.pop(), En.push(t), X(On), On = W(Tn, 500, t.event);
                break;
            default:
                En.push(t), Tn(t.event)
        }
    }
    ...
    function jn(t) {
        ...
        if ((null !== t || 0 !== i || 0 !== o) && null !== i && null !== o) {
            ...
            }(l, u) && Cn.pop(), Cn.push(u), X(Dn), Dn = W(An, 500, 10)
        }
    }
    ...
    function Hn(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            var n = Ln.start ? Ln.start : null;
            null !== Rn && null !== Ln.start && n !== e.anchorNode && (X(zn), Yn(21)), Ln = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, Rn = e, X(zn), zn = W(Yn, 500, 21)
        }
    }
    ...
    function Gn(t) {
        ! function(t) {
            var e = Jt(t);
            ai(e ? e.contentWindow : t === document ? window : t, "scroll", jn, !0)
        }(t), t.nodeType === Node.DOCUMENT_NODE && (un(t), function(t) {
            ai(t, "cut", pn.bind(this, 0), !0), ai(t, "copy", pn.bind(this, 1), !0), ai(t, "paste", pn.bind(this, 2), !0)
        }(t), function(t) {
            ai(t, "mousedown", Sn.bind(this, 13, t), !0), ai(t, "mouseup", Sn.bind(this, 14, t), !0), ai(t, "mousemove", Sn.bind(this, 12, t), !0), ai(t, "wheel", Sn.bind(this, 15, t), !0), ai(t, "dblclick", Sn.bind(this, 16, t), !0), ai(t, "touchstart", xn.bind(this, 17, t), !0), ai(t, "touchend", xn.bind(this, 18, t), !0), ai(t, "touchmove", xn.bind(this, 19, t), !0), ai(t, "touchcancel", xn.bind(this, 20, t), !0)
        }(t), function(t) {
            ai(t, "input", bn, !0)
        }(t), function(t) {
            ai(t, "selectstart", Hn.bind(this, t), !0), ai(t, "selectionchange", Hn.bind(this, t), !0)
        }(t), function(t) {
            ai(t, "change", en, !0)
        }(t), function(t) {
            ai(t, "submit", Un, !0)
    ...
    var Zn = Object.freeze({
            ...
            observe: Gn,
            start: function() {
                Na = [], Ma(), fn(), vn(), Mn(), wn(), ai(window, "resize", _n), _n(), ai(document, "visibilitychange", Jn), Jn(), Cn = [], jn(), qn(), nn(), Bn(), ai(window, "pagehide", Vn)
            },
            stop: function() {
                Na = [], Ma(), fn(), vn(), X(On), En.length > 0 && Tn(En[En.length - 1].event), X(gn), wn(), In(), Kn(), X(Dn), Cn = [], qn(), X(zn), nn(), Bn(), Fn()
            }
        }),
        Qn = /[^0-9\.]/g;
    ...
    function $n(t) {
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                case "article":
                case "recipe":
                    Nr(5, t[a]), Nr(8, t.creator), Nr(18, t.headline);
                    break;
                case "product":
                    Nr(5, t[a]), Nr(10, t.name), Nr(12, t.sku), t.brand && Nr(6, t.brand.name);
                    break;
                case "aggregaterating":
                    t.ratingValue && (q(11, ta(t.ratingValue, 100)), q(18, ta(t.bestRating)), q(19, ta(t.worstRating))), q(12, ta(t.ratingCount)), q(17, ta(t.reviewCount));
                    break;
                case "person":
                    Nr(8, t.name);
                    break;
                case "offer":
                    Nr(7, t.availability), Nr(14, t.itemCondition), Nr(13, t.priceCurrency), Nr(12, t.sku), q(13, ta(t.price));
                    break;
                case "brand":
                    Nr(6, t.name)
            }
            null !== r && "object" == typeof r && $n(r)
        }
    }
    ...
    function ta(t, e) {
        if (void 0 === e && (e = 1), null !== t) switch (typeof t) {
            ...
            case "string":
                return Math.round(parseFloat(t.replace(Qn, "")) * e)
        }
        return null
    }
    var ea = ["title", "alt", "onload", "onfocus", "onerror", "data-drupal-form-submit-last"],
        na = /[\r\n]+/g;
                ...
                switch (i = t.parentElement ? t.parentElement : t.parentNode ? t.parentNode : null, "http://www.w3.org/2000/svg" === v.namespaceURI && (g = "svg:" + g), g) {
                    ...
                    case "SCRIPT":
                        if ("type" in m && "application/ld+json" === m.type) try {
                            $n(JSON.parse(v.text.replace(na, "")))
                        } catch (t) {}
                        break;
                    case "NOSCRIPT":
                        break;
                    ...
                    case "HEAD":
                        ...
                        k.attributes["*B"] = E.protocol + "//" + E.host + E.pathname, oe[r](t, i, k, e);
                        break;
                    case "BASE":
                    ...
                    case "IFRAME":
                        ...
                        Ft(N) && (! function(t) {
                            !1 === ee(t) && ai(t, "load", Ea.bind(this, t, "childList"), !0)
                        }(N), T.attributes["*O"] = "true", N.contentDocument && N.contentWindow && "loading" !== N.contentDocument.readyState && (a = N.contentDocument)), oe[r](t, i, T, e);
                        break;
                    case "LINK":
                        if (Cr && "stylesheet" === m.rel) {
                            for (var M in Object.keys(document.styleSheets)) {
                                var _ = document.styleSheets[M];
                                if (_.ownerNode == v) {
                                    var I = {
                                        tag: "STYLE",
                                        attributes: m,
                    ...
                    default:
                        ...
                        v.shadowRoot && (a = v.shadowRoot), oe[r](t, i, D, e)
                }
        }
        return a
    }
        ...
        ee(t) || (! function(t) {
            try {
                var e = u("MutationObserver"),
                    n = e in window ? new window[e](ei(ma)) : null;
                n && (n.observe(t, {
                    attributes: !0,
                    childList: !0,
                    characterData: !0,
    ...
    function ia(t) {
        ...
        return (0 === e.length || n > 0) && (e = oa(t.sheet)), e
    }
    ...
    function oa(t) {
        ...
        try {
            ...
            if (Qa(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
            ...
            return rt(this, (function(c) {
                switch (c.label) {
                    ...
                    case 2:
                        o = c.sent(), c.label = 3;
                    case 3:
                        return 2 === o ? [3, 4] : ((u = aa(r, n)) && a.push(u), [3, 1]);
                    case 4:
                        return [2]
                }
            }))
        ...
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(d) {
                switch (d.label) {
                    ...
                    case 1:
                        if (!(sa.length > 0)) return [3, 8];
                        e = sa.shift(), n = s(), a = 0, r = e.mutations, d.label = 2;
                    case 2:
                        ...
                        switch (u = i.target, c = function(t, e, n) {
                            ...
                            if (a && "HTML" !== a.data.tag) {
                                var r = s() > va,
                                    ...
                                    u = [a.selector ? a.selector.join() : "", o, t.attributeName, ya(t.addedNodes), ya(t.removedNodes)].join();
                                ga[u] = u in ga ? ga[u] : [0, n];
                                var c = ga[u];
                                if (!1 === r && c[0] >= 10 && wa(c[2], 2, e), c[0] = r ? c[1] === n ? c[0] : c[0] + 1 : 1, c[1] = n, 10 === c[0]) return c[2] = t.removedNodes, "suspend";
                                if (c[0] > 10) return ""
                            }
                            return t.type
                            ...
                            case "characterData":
                                ...
                                break;
                            case "childList":
                                wa(i.addedNodes, 1, t), wa(i.removedNodes, 2, t);
                                break;
                            case "suspend":
        ...
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(o) {
                switch (o.label) {
                    ...
                    case 1:
                        return r < a ? 1 !== e ? [3, 2] : (ua(t[r], n, e), [3, 5]) : [3, 6];
                    case 2:
    ...
    function ka(t) {
        return ha.indexOf(t) < 0 && ha.push(t), pa && X(pa), pa = W((function() {
            ! function() {
                for (var t = 0, e = ha; t < e.length; t++) {
                    var n = e[t];
                    if (n) {
    ...
    function Oa(t) {
        ...
        return va = s() + 3e3, n.nodeType === Node.DOCUMENT_NODE ? n.documentElement : n
    }
        ...
        return void 0 === e && (e = null), at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(H) {
                switch (n = e || s(), a = [n, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (r = 0, i = En; r < i.length; r++) R = i[r], (o = Sa(R.data.target, R.event)).id > 0 && ((a = [R.time, R.event]).push(o.id), a.push(R.data.x), a.push(R.data.y), qa(a), M(R.event, R.data.x, R.data.y));
                        Mn();
                        break;
                    case 9:
                        for (u = 0, c = on; u < c.length; u++) R = c[u], l = Sa(R.data.target, R.event, R.data.text), a = [R.time, R.event], d = l.hash ? l.hash.join(".") : "", a.push(l.id), a.push(R.data.x), a.push(R.data.y), a.push(R.data.eX), a.push(R.data.eY), a.push(R.data.button), a.push(R.data.reaction), a.push(R.data.context), a.push(m(R.data.text, "click", l.privacy)), a.push(b(R.data.link)), a.push(d), a.push(R.data.trust), qa(a), _a(R.time, R.event, d, R.data.x, R.data.y, R.data.reaction, R.data.context);
                        fn();
                        break;
                    case 38:
                        for (f = 0, h = hn; f < h.length; f++) R = h[f], a = [R.time, R.event], (j = Sa(R.data.target, R.event)).id > 0 && (a.push(j.id), a.push(R.data.action), qa(a));
                        vn();
                        break;
                    case 11:
                        p = kn, a.push(p.width), a.push(p.height), M(t, p.width, p.height), In(), qa(a);
                        break;
                    case 26:
                        v = Wn, a.push(v.name), Fn(), qa(a);
                        break;
                    case 27:
                        for (g = 0, y = mn; g < y.length; g++) R = y[g], w = Sa(R.data.target, R.event, R.data.value), (a = [R.time, R.event]).push(w.id), a.push(m(R.data.value, "input", w.privacy)), qa(a);
                        wn();
                        break;
                    case 21:
                        (k = Ln) && (E = Sa(k.start, t), O = Sa(k.end, t), a.push(E.id), a.push(k.startOffset), a.push(O.id), a.push(k.endOffset), qn(), qa(a));
                        break;
                    case 10:
                        for (S = 0, x = Cn; S < x.length; S++) R = x[S], (N = Sa(R.data.target, R.event)).id > 0 && ((a = [R.time, R.event]).push(N.id), a.push(R.data.x), a.push(R.data.y), qa(a), M(R.event, R.data.x, R.data.y));
                        Cn = [];
                        break;
                    case 42:
                        for (T = 0, _ = tn; T < _.length; T++) R = _[T], a = [R.time, R.event], (j = Sa(R.data.target, R.event)).id > 0 && ((a = [R.time, R.event]).push(j.id), a.push(R.data.type), a.push(m(R.data.value, "change", j.privacy)), a.push(m(R.data.checksum, "checksum", j.privacy)), qa(a));
                        nn();
                        break;
                    case 39:
                        for (C = 0, D = Pn; C < D.length; C++) R = D[C], a = [R.time, R.event], (j = Sa(R.data.target, R.event)).id > 0 && (a.push(j.id), qa(a));
                        Bn();
                        break;
                    case 22:
                        for (A = 0, L = Ta; A < L.length; A++) R = L[A], (a = [R.time, R.event]).push(R.data.type), a.push(R.data.hash), a.push(R.data.x), a.push(R.data.y), a.push(R.data.reaction), a.push(R.data.context), qa(a, !1);
                        Ma();
                        break;
                    case 28:
                        z = Xn, a.push(z.visible), qa(a), I(n, z.visible), Kn()
                }
                return [2]
            }))
        }))
    ...
    function _a(t, e, n, a, r, i, o) {
        void 0 === i && (i = 1), void 0 === o && (o = 0), Na.push({
            time: t,
            event: 22,
            data: {
                type: e,
    ...
    var Ia, Ca, Da, ja, Aa, La = 0,
        Ra = 0,
        za = null,
        Ha = 0;

    function Ya() {
        ja = !0, La = 0, Ra = 0, Ha = 0, Ia = [], Ca = [], Da = {}, Aa = null
    }
    ...
    function qa(t, e) {
        if (void 0 === e && (e = !0), ja) {
            ...
            H(25);
            var i = function() {
                var t = !1 === o.lean && La > 0 ? 100 : Kr.sequence * o.delay;
                return "string" == typeof o.upload ? Math.max(Math.min(t, 3e4), 100) : o.delay
            }();
            n - Ha > 2 * i && (X(za), za = null), e && null === za && (25 !== a && V(), za = W(Xa, i), Ha = n, br(Ra))
        }
    }

    function Wa() {
        X(za), Xa(!0), La = 0, Ra = 0, Ha = 0, Ia = [], Ca = [], Da = {}, Aa = null, ja = !1
    }
    ...
    function Xa(t) {
        return void 0 === t && (t = !1), at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return za = null, (e = !1 === o.lean && Ra > 0 && (Ra < 1048576 || Kr.sequence > 0)) && q(1, 1), Ke(),
                            function() {
                                var t = [];
                                Ta = [];
                                for (var e = Kr.start + Kr.duration, n = Math.max(e - 2e3, 0), a = 0, r = Na; a < r.length; a++) {
                                    var i = r[a];
                                    i.time >= n && (i.time <= e && Ta.push(i), t.push(i))
                                }
                                Na = t, xa(22)
                            }(), yt(), n = !0 === t, a = JSON.stringify(Qr(n)), r = "[".concat(Ca.join(), "]"), i = e ? "[".concat(Ia.join(), "]") : "", u = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return Y(2, (c = s) ? c.length : u.length), Pa(u, c, Kr.sequence, n), Ca = [], e && (Ia = [], Ra = 0, La = 0), [2]
                }
            }))
        }))
    }
        ...
        if (void 0 === a && (a = !1), "string" == typeof o.upload) {
            ...
            if (!1 === i) {
                ...
                u.open("POST", r, !0), u.timeout = 15e3, u.ontimeout = function() {
                    ti(new Error("".concat("Timeout", " : ").concat(r)))
    ...
    function Ua(t, e) {
        var n = Da[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? yr(6) : (0 === t.status && (o.upload = o.fallback ? o.fallback : o.upload), Pa(n.data, null, e)) : (Aa = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        }, n.attempts > 1 && gr(2), 200 === t.status && t.responseText && function(t) {
        ...
        }(t.responseText), 0 === t.status && (Pa(n.data, null, e, !0), yr(3)), t.status >= 200 && t.status <= 208 && Ba(e), delete Da[e]))
    }
    ...
    function Ja(t) {
        var e = t.error || t;
        return e.message in Fa || (Fa[e.message] = 0), Fa[e.message]++ >= 5 || e && e.message && (Va = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function Ka(t) {
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(n) {
                switch (e = [s(), t], t) {
                    case 31:
                        e.push(Va.message), e.push(Va.line), e.push(Va.column), e.push(Va.stack), e.push(b(Va.source)), qa(e);
                        break;
                    case 33:
                        Ga && (e.push(Ga.code), e.push(Ga.name), e.push(Ga.message), e.push(Ga.stack), e.push(Ga.severity), qa(e, !1));
                        break;
                    case 41:
                        wt && (e.push(wt.id), e.push(wt.target), e.push(wt.checksum), qa(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function Qa(t, e, n, a, r) {
        void 0 === n && (n = null), void 0 === a && (a = null), void 0 === r && (r = null);
        var i = n ? "".concat(n, "|").concat(a) : "";
        t in Za && Za[t].indexOf(i) >= 0 || (Ga = {
            code: t,
            name: n,
            message: a,
            stack: r,
            severity: e
        }, t in Za ? Za[t].push(i) : Za[t] = [i], Ka(33))
    }
    var $a, tr = {},
        er = new Set,
        nr = {},
    ...
    function ur(t) {
        try {
            ...
            for (var o in nr[a] = {}, ar[a] = {}, rr[a] = {}, ir[a] = r, i) {
                var u = parseInt(o),
                    c = i[o],
                    s = 2;
        ...
        try {
            for (var t in nr) {
                ...
                if ("" == ir[e] || document.querySelector(ir[e])) {
                    ...
                    for (var a in n) {
                        var r = parseInt(a),
                            i = (h = pr(cr(n[r]))) ? JSON.stringify(h).substring(0, 1e4) : h;
                        i && dr(e, r, i)
                    }
                    var o = ar[e];
                    for (var u in o) {
                        ...
                        if (s) dr(e, c, Array.from(s).map((function(t) {
                    ...
                    for (var d in l) {
                        var f = parseInt(d);
                        dr(e, f, Zt(l[f]).trim().substring(0, 1e4))
                    }
                }
            }
            er.size > 0 && gr(40)
    ...
    function dr(t, e, n) {
        var a, r = !1;
        t in tr || (tr[t] = {}, r = !0), a = rr[t], 0 == Object.keys(a).length || e in tr[t] && tr[t][e] == n || (r = !0), tr[t][e] = n, r && er.add(t)
    }
    ...
    function pr(t, e) {
        ...
        if (e && e[a.name]) {
            var r = e[a.name];
            if (1 !== a.type && vr(r, a.condition)) n = pr(t, r);
    ...
    function gr(t) {
        ...
        switch (t) {
            case 4:
                var n = S;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), qa(e, !1)), T();
                break;
            case 25:
                e.push(L.gap), qa(e);
                break;
            case 35:
                e.push($a.check), qa(e, !1);
                break;
            case 3:
                e.push(tt.key), qa(e);
                break;
            case 2:
                e.push(Aa.sequence), e.push(Aa.attempts), e.push(Aa.status), qa(e, !1);
                break;
            case 24:
                j.key && e.push(j.key), e.push(j.value), qa(e);
                break;
            case 34:
            ...
            case 0:
                ...
                break;
            case 1:
                var h = Object.keys(Or);
                if (h.length > 0) {
                    for (var p = 0, v = h; p < v.length; p++) {
                        var g = v[p];
                        f = parseInt(g, 10);
                        e.push(f), e.push(Or[g])
                    }
                    Mr(), qa(e, !1)
                }
                break;
    ...
    function br(t) {
        if (0 === $a.check) {
            var e = $a.check;
            e = Kr.sequence >= 128 ? 1 : e, e = Kr.pageNum >= 128 ? 7 : e, e = s() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== $a.check && yr(e)
        }
    }
    ...
    function Nr(t, e) {
        e && (e = "".concat(e), t in Er || (Er[t] = []), Er[t].indexOf(e) < 0 && (Er[t].push(e), t in Or || (Or[t] = []), Or[t].push(e), Er[t].length > 128 && yr(5)))
    }
    ...
    function jr() {
        ...
        _r = {
            ...
            sessionId: a.session,
            pageNum: a.count
        }, o.lean = o.track && null !== a.upgrade ? 0 === a.upgrade : o.lean, o.upload = o.track && "string" == typeof o.upload && a.upload && a.upload.length > "https://".length ? a.upload : o.upload, Nr(0, t), Nr(3, e), Nr(1, b(location.href, !!Cr)), Nr(2, document.referrer), Nr(15, function() {
            var t = Xr();
            if (o.track && qr(window, "sessionStorage")) {
                var e = sessionStorage.getItem("_cltk");
                t = e || t, sessionStorage.setItem("_cltk", t)
            }
            return t
        }()), Nr(16, document.documentElement.lang), Nr(17, document.dir), Nr(26, "".concat(window.devicePixelRatio)), Nr(28, r.dob.toString()), Nr(29, r.version.toString()), q(0, a.ts), q(1, 0), q(35, Cr), navigator && (Nr(9, navigator.language), q(33, navigator.hardwareConcurrency), q(32, navigator.maxTouchPoints), q(34, Math.round(navigator.deviceMemory)), (n = navigator.userAgentData) && n.getHighEntropyValues ? n.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            Nr(22, t.platform), Nr(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                Nr(24, t.name + "~" + t.version)
            })), Nr(25, t.model), q(27, t.mobile ? 1 : 0)
        })) : Nr(22, navigator.platform)), screen && (q(14, Math.round(screen.width)), q(15, Math.round(screen.height)), q(16, Math.round(screen.colorDepth)));
    ...
    function Rr() {
        return _r ? [_r.userId, _r.sessionId, _r.pageNum].join(".") : ""
    }

    function zr(t) {
        if (void 0 === t && (t = !0), !t) return Fr("_clsk", "", 0), Fr("_clck", "", 0), Di(), void window.setTimeout(Ci, 250);
        gi() && (o.track = !0, Wr(Ur(), 1))
    }
    ...
    function Yr() {
        var t = Math.round(Date.now()),
            ...
            n = o.lean ? 0 : 1;
        ! function(t) {
            Ir.length > 0 && Ir.forEach((function(e) {
                !e.callback || e.wait && !t || e.callback(_r, !o.lean)
            }))
        }(n), Fr("_clsk", [_r.sessionId, t, _r.pageNum, n, e].join("|"), 1)
    }
    ...
    function Wr(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e || t.dob !== a) && Fr("_clck", [_r.userId, 2, n.toString(36), e, a].join("|"), 365)
    }
    ...
    function Br(t) {
        var e;
        if (qr(document, "cookie")) {
            var n = document.cookie.split(";");
            if (n)
                for (var a = 0; a < n.length; a++) {
                    var r = n[a].split("=");
                    if (r.length > 1 && r[0] && r[0].trim() === t) {
                        for (var i = Vr(r[1]), o = i[0], u = i[1]; o;) o = (e = Vr(u))[0], u = e[1];
                        return u
                    }
                }
        }
    ...
    function Fr(t, e, n) {
        if (o.track && (navigator && navigator.cookieEnabled || qr(document, "cookie"))) {
            var a = function(t) {
            ...
            try {
                if (null === Dr) {
                    for (var c = location.hostname ? location.hostname.split(".") : [], s = c.length - 1; s >= 0; s--)
                        if (Dr = ".".concat(c[s]).concat(Dr || ""), s < c.length - 1 && (document.cookie = "".concat(u).concat(";").concat("domain=").concat(Dr), Br(t) === e)) return;
                    Dr = ""
                }
            } catch (t) {
                Dr = ""
            }
            document.cookie = Dr ? "".concat(u).concat(";").concat("domain=").concat(Dr) : u
        }
    }
    var Jr, Kr = null;
    ...
    function Qr(t) {
        return Kr.start = Kr.start + Kr.duration, Kr.duration = s() - Kr.start, Kr.sequence++, Kr.upload = t && "sendBeacon" in navigator ? 1 : 0, Kr.end = t ? 1 : 0, [Kr.version, Kr.sequence, Kr.start, Kr.duration, Kr.projectId, Kr.userId, Kr.sessionId, Kr.pageNum, Kr.upload, Kr.end]
    }
    ...
    function si() {
        return !(ci++ > 20) || (Qa(4, 0), !1)
    }

    function li() {
        ci = 0, ui !== fi() && (Di(), window.setTimeout(di, 250))
    }
    ...
    function pi() {
        hi = !0, c = performance.now(), he(), ri(), $r(), ui = fi(), ci = 0, ai(window, "popstate", li), null === ii && (ii = history.pushState, history.pushState = function() {
            ii.apply(this, arguments), gi() && si() && li()
        }), null === oi && (oi = history.replaceState, history.replaceState = function() {
            oi.apply(this, arguments), gi() && si() && li()
        })
    }

    function vi() {
        ui = null, ci = 0, $r(), ri(), he(), c = 0, hi = !1
    }
    ...
    function mi(t) {
        if (null === t || hi) return !1;
        for (var e in t) e in o && (o[e] = t[e]);
        return !0
    }

    function bi() {
        Ci(), A("clarity", "restart")
    }
    ...
    var ki = Object.freeze({
        ...
        hashText: Zt,
        start: function() {
            Se(), xe(), $e(), Ve = null, Xe = new WeakMap, Pe = {}, Ue = [], Be = !!window.IntersectionObserver, Xt(),
                function() {
                    if (ca = [], ha = [], pa = null, va = 0, ga = {}, null === la && (la = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
                            return gi() && ka(this.ownerNode), la.apply(this, arguments)
                        }), null === da && (da = CSSStyleSheet.prototype.deleteRule, CSSStyleSheet.prototype.deleteRule = function() {
                            return gi() && ka(this.ownerNode), da.apply(this, arguments)
                        }), null === fa) {
                        fa = Element.prototype.attachShadow;
                        try {
                            Element.prototype.attachShadow = function() {
                                return gi() ? ka(fa.apply(this, arguments)) : fa.apply(this, arguments)
                            }
                        } catch (t) {
                            fa = null
                        }
                    }
                }(), pe(wi, 1).then((function() {
                    ei(xe)(), ei(Ke)()
                })), window.Animation && window.KeyframeEffect && window.KeyframeEffect.prototype.getKeyframes && window.KeyframeEffect.prototype.getTiming && (Ae(), Re(Te, "play"), Re(Me, "pause"), Re(_e, "cancel"), Re(Ie, "finish"))
        },
        stop: function() {
            $e(), Xe = null, Pe = {}, Ue = [], Ve && (Ve.disconnect(), Ve = null), Be = !1, Pt(),
                function() {
                    for (var t = 0, e = ca; t < e.length; t++) {
                        var n = e[t];
                        n && n.disconnect()
                    }
                    ca = [], ga = {}, sa = [], ha = [], va = 0, pa = null
                }(), Se(), Ae()
        }
    });
    var Ei, Oi = null;
        ...
        Oi = {
            ...
            function(t) {
                at(this, void 0, void 0, (function() {
                    var e, n;
                    return rt(this, (function(a) {
                        return e = s(), n = [e, t], 29 === t && (n.push(Oi.fetchStart), n.push(Oi.connectStart), n.push(Oi.connectEnd), n.push(Oi.requestStart), n.push(Oi.responseStart), n.push(Oi.responseEnd), n.push(Oi.domInteractive), n.push(Oi.domComplete), n.push(Oi.loadEventStart), n.push(Oi.loadEventEnd), n.push(Oi.redirectCount), n.push(Oi.size), n.push(Oi.type), n.push(Oi.protocol), n.push(Oi.encodedSize), n.push(Oi.decodedSize), Si(), qa(n)), [2]
                    }))
                }))
            }(29)
    }
    ...
    function Ti() {
        try {
            Ei && Ei.disconnect(), Ei = new PerformanceObserver(ei(Mi));
            for (var t = 0, e = Ni; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && Y(9, 0), Ei.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        Nr(4, _i(r)), r !== o.upload && r !== o.fallback || q(28, a.duration);
                        break;
                    case "longtask":
                        H(7);
                        break;
    ...
    var Ii = [yi, ki, Zn, Object.freeze({
        __proto__: null,
        start: function() {
            Si(),
                function() {
                    navigator && "connection" in navigator && Nr(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? ai(window, "load", W.bind(this, Ti, 0)) : Ti() : Qa(3, 0)
                }()
        },
        stop: function() {
            Ei && Ei.disconnect(), Ei = null, Si()
        }
    })];
    ...
    function Ci(t) {
        void 0 === t && (t = null),
            function() {
                try {
                    return !1 === hi && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap
                } catch (t) {
                    return !1
                }
            }() && (mi(t), pi(), mt(), Ii.forEach((function(t) {
                return ei(t.start)()
            })), null === t && Ri())
    }

    function Di() {
        gi() && (Ii.slice().reverse().forEach((function(t) {
            return ei(t.stop)()
        })), bt(), vi(), void 0 !== Ai && (Ai[Li] = function() {
            (Ai[Li].q = Ai[Li].q || []).push(arguments), "start" === arguments[0] && Ai[Li].q.unshift(Ai[Li].q.pop()) && Ri()
        }))
    }
    var ji = Object.freeze({
            ...
            metadata: Lr,
            pause: function() {
                gi() && (A("clarity", "pause"), null === de && (de = new Promise((function(t) {
                    fe = t
                }))))
            },
            resume: function() {
                gi() && (de && (fe(), de = null, null === le && ve()), A("clarity", "resume"))
            },
            set: ot,
            start: Ci,
            stop: Di,
    ...
    function Ri() {
        if (void 0 !== Ai) {
            if (Ai[Li] && Ai[Li].v) return console.warn("Error CL001: Multiple Clarity tags detected.");
            var t = Ai[Li] && Ai[Li].q || [];
            for (Ai[Li] = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    return ji[t].apply(ji, e)
                }, Ai[Li].v = l; t.length > 0;) Ai[Li].apply(Ai, t.shift())
        }
    }
    Ri()
}();